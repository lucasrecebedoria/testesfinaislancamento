...
function printThermalReceipt(data) {
  ...
  <body onload="window.print(); setTimeout(()=>window.close(), 500);">
    ...
    <div class="line">Tipo de validador: ${data.tipoValidador}</div>
    <div class="line">PREFIXO: ${data.prefixo}</div>
    <div class="line">QUANTIDADE BORDOS: ${data.qtdBordos}</div>
    <div class="line">VALOR: R$ ${Number(data.valor).toFixed(2)}</div>
    <div class="line">MATRICULA MOTORISTA: ${data.matriculaMotorista}</div>
    <div class="line">MATRICULA RECEBEDOR: ${data.matriculaRecebedor}</div>
    <div class="line">DATA RECEBIMENTO: ${dt}</div>
    <div class="sig">ASSINATURA RECEBEDOR:<br>_____________________________</div>
  </body></html>`;
